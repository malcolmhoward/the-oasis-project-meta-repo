...
| `ethical-awareness` | #7057ff | Tier 3: Inherits Principle Zero from PFT |
...
---
Ethical Awareness: This milestone inherits Principle Zero ("Do No Harm, Allow No Harm") from PFT.
```
...
---
*Ethical Awareness: This work inherits Principle Zero from PFT.*
```
